...
const Landing = () => {
  ...
  return (
    <div ref={el} className='h-screen'>
      <div className='imgFor max-w-2xl h-[80vh] rounded-b-full absolute top-0 md:left-1/2 -translate-x-1/2 overflow-hidden z-0'>
        <img
          id='hero1'
          src={hero1}
          alt=''
      ...
      <div className='h-full w-full flex items-center z-10 relative'>
        <div className='flex w-full'>
          <div className='w-full md:w-1/2 flex flex-col items-start'>
            <h1 id='hero-title' className='heroElement font-bold text-2xl lg:text-7xl'>
